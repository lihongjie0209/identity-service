...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("jwt.audiences", []string{"identity-service", "tenant-service", "authorization-service", "audit-service", "config-service", "notification-service", "file-service", "scheduler-service", "swagger-service", "application-service", "dictionary-service", "webhook-service"})
